...
INSERT INTO `modulo` (`ip`, `idWebSocket`, `desc`) VALUES
('0.0.0.0',NULL,'Módulo 0'),
('192.168.1.101',NULL,'Módulo 1'),
('192.168.1.102',NULL,'Módulo 2'),
('192.168.1.103',NULL,'Módulo 3'),
('192.168.1.104',NULL,'Módulo 4'),
('192.168.1.105',NULL,'Módulo 5'),
('192.168.1.106',NULL,'Módulo 6'),
('192.168.1.107',NULL,'Módulo 7');
...
(0, 1, 0, 0, 0, 0, 0, 1, 'Equipamento sem Tomada'),
(1, 1, 1, 0.5, 0.5, 0.2, 0.2, 2, 'Tomada 1'),
(2, 1, 2, 0.5, 0.5, 0.2, 0.2, 3, 'Tomada 2'),
(3, 1, 3, 0.5, 0.5, 0.2, 0.2, 4, 'Tomada 3'),
(4, 1, 4, 0.5, 0.5, 0.2, 0.2, 5, 'Tomada 4'),
(5, 1, 5, 0.5, 0.5, 0.2, 0.2, 6, 'Tomada 5'),
(6, 1, 6, 0.5, 0.5, 0.2, 0.2, 7, 'Tomada 6'),
(7, 1, 7, 0.5, 0.5, 0.2, 0.2, 8, 'Tomada 7'),
(8, 1, 8, 0.5, 0.5, 0.2, 0.2, 3, 'Tomada 8'),
(9, 1, 9, 0.5, 0.5, 0.2, 0.2, 4, 'Tomada 9');
